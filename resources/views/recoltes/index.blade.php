...
@section('content')
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        {{-- SECTION : TITRE --}}
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Gestion des Récoltes</h1>
            <p class="text-gray-600 text-sm mt-1">Ajouter, modifier, filtrer et suivre les récoltes</p>
        </div>
