...
('Roma', 'Chair ferme, idéale pour sauces et conserves', 1),
('Cerise', 'Petite taille, saveur sucrée, parfaite en salade', 1),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Charlotte', 'Chair ferme, excellente pour les salades', 2),
('Bintje', 'Polyvalente, idéale pour frites et purées', 2),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Nantaise', 'Longue et droite, saveur sucrée', 3),
('Chantenay', 'Courte et trapue, idéale pour les sols lourds', 3),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Laitue Batavia', 'Feuilles craquantes, résistante à la chaleur', 4),
('Feuille de Chêne', 'Feuilles découpées, tendres', 4),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Jaune Paille', 'Classique, bonne conservation', 5),
('Rouge de Florence', 'Saveur douce, idéal cru', 5),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Ronde de Nice', 'Forme ronde, farcie excellente', 6),
('Grisette de Provence', 'Peau gris-vert, chair fine', 6),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Doux des Landes', 'Carré, chair épaisse, très doux', 7),
('Corno di Toro', 'Forme de corne, saveur fruitée', 7),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Violette de Florence', 'Forme allongée, peau violet vif', 8),
('Ronde de Valence', 'Forme ronde, idéale pour farcir', 8),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Marketmore', 'Peau vert foncé, peu amère', 9),
('Lemon', 'Forme ronde, couleur jaune citron', 9),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Fin de Bagnols', 'Très fin, sans fil, tendre', 10),
('Contender', 'Productif, gousse ronde', 10),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Géant d''Hiver', 'Feuilles larges, résistant au froid', 11),
('Matador', 'Précoce, peu sensible à la montée', 11),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Chou de Milan', 'Feuilles cloquées, résistant au froid', 12),
('Chou cabus', 'Feuilles lisses, pomme serrée', 12),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Calabrais', 'Grosse tête verte, classique', 13),
('Romanesco', 'Forme fractale, couleur vert pomme', 13),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Blanc précoce', 'Récolte estivale, pomme blanche', 14),
('Violet de Sicile', 'Couleur violette, riche en antioxydants', 14),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Navet de Milan', 'Rond, plat, couleur rouge et blanc', 15),
('Nancy', 'Allongé, chair blanche tendre', 15),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Rond écarlate', 'Classique, rond et rouge', 16),
('Flamboyant', 'Allongé, rouge vif', 16),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Detroit', 'Ronde, rouge foncé, très productive', 17),
('Crapaudine', 'Forme allongée, saveur sucrée', 17),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Gariguette', 'Allongée, très parfumée, précoce', 18),
('Charlotte', 'Ronde, rouge brillant, remontante', 18),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Meeker', 'Fruit moyen, rouge foncé, productif', 19),
('Heritage', 'Remontante, production automnale', 19),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Golden Delicious', 'Jaune, sucrée, polyvalente', 20),
('Granny Smith', 'Verte, acidulée, bonne à cuire', 20),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Williams', 'Jaune, très parfumée, chair fondante', 21),
('Conference', 'Allongée, ferme, bonne conservation', 21),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Burlat', 'Précoce, gros fruit rouge foncé', 22),
('Reverchon', 'Ferme, sucrée, bonne conservation', 22),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Grosse Mignonne', 'Grosse, chair blanche fondante', 23),
('Sanguine', 'Chair rouge, saveur particulière', 23),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Rouge du Roussillon', 'Couleur rouge orangé, très parfumé', 24),
('Bergeron', 'Gros, chair ferme, pour conserver', 24),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Charentais', 'Petit, très parfumé, chair orange', 25),
('Galia', 'Peau réticulée, chair vert pâle', 25),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Sugar Baby', 'Petite taille, peau vert foncé', 26),
('Crimson Sweet', 'Rayée, chair rouge sucrée', 26),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Chasselas', 'Blanc, grains dorés, saveur fine', 27),
('Muscat de Hambourg', 'Noir, très parfumé', 27),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Hayward', 'Standard, gros fruit, bonne conservation', 28),
('Soreli', 'Précoce, chair jaune', 28),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Violette de Solliès', 'Peau violette, chair rouge', 29),
('Blanche d''Argenteuil', 'Peau verte, chair rose', 29),
...
INSERT INTO varietees (nom_varietee, caracteristique_varietee, produit_id) VALUES
('Thornfree', 'Sans épines, gros fruits', 30),
('Chester', 'Sans épines, très productive', 30),
('Loch Ness', 'Sans épines, longue période de récolte', 30),
('Triple Crown', 'Sans épines, gros fruits sucrés', 30),
('Navaho', 'Érigée, autofertile', 30);
