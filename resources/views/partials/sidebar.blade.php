<!-- Sidebar Artistique avec DaisyUI -->
<div class="w-64 bg-gradient-to-b from-green-100 via-white to-green-50 shadow-2xl overflow-y-auto border-r-2 border-green-200">
    <div class="p-6">
