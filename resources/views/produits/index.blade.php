                    ...
                    <table class="table table-zebra table-sm sm:table-md">
                        <thead>
                            <tr class="bg-base-200">
                                ...
                                <th class="font-semibold text-xs sm:text-sm py-2">Variétés</th>
                                    ...
                                    <td class="py-2">
                                        <div class="flex items-center gap-2">
                                            <div class="avatar placeholder">
                                                <div
                                                    class="flex items-center justify-center bg-orange-100 text-orange-600 rounded-full w-6 h-6 sm:w-7 sm:h-7">
                                                    <i class="fas fa-carrot text-xs"></i>
                                                </div>
                                            </div>
                                            <span
                                                class="font-medium text-xs sm:text-sm truncate max-w-[120px] sm:max-w-[200px]">{{ $produit->nom_produit }}</span>
                                        </div>
                                    </td>
                                    <td class="py-2">
                                        <div class="max-w-[150px] sm:max-w-xs">
                                            <span
                                                class="truncate-2-lines text-xs sm:text-sm">{{ $produit->description_produit }}</span>
                                        </div>
                                    </td>
                                    <td class="py-2">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <span
                                                    class="font-medium text-xs">{{ $produit->varietees_count ?? $produit->varietees->count() }}</span>
                                                <div class="text-gray-500 text-xs">variétés</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-2">
                                    ...
                                    <td colspan="5" class="text-center py-6">
                                        <div class="flex flex-col items-center justify-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-500 text-xs mt-1">Commencez par créer votre premier
                                                    produit</p>
                                            </div>
